        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alergies = table.Column<bool>(type: "bit", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prueba de laboratorio", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resultado_Paciente_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Paciente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Resultado_Prueba de laboratorio_LaboratoryTestId",
                        column: x => x.LaboratoryTestId,
                        principalTable: "Prueba de laboratorio",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cita_PatientId",
                table: "Cita",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Resultado_LaboratoryTestId",
                table: "Resultado",
                column: "LaboratoryTestId");

            migrationBuilder.CreateIndex(
                name: "IX_Resultado_PatientId",
                table: "Resultado",
                column: "PatientId");
